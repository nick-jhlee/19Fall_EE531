...
\begin{itemize}
	\item \alert{Graph kernel}: kernel function that defines {\it inner product on graphs} \footfullcite{Gartner2003}\footfullcite{Kashima2003}\footfullcite{Vishwanathan2010}
...
(Function measuring the similarity of a pair of two given graphs) \pause
	...
	\item \alert{Weisfeiler-Lehman subtree kernel}\footfullcite{Shervashidze2009}\footfullcite{Shervashidze2011}: counts common {\it original and compressed labels} (resulting from 1-dim WL test) in two graphs.
\end{itemize}
